...
/**
 * Prism (React Bits, adaptado a TS) — prisma 3D renderizado con OGL/WebGL.
 * Lógica de shader y ciclo de vida intactos; solo se tipó y se cambió el
 * `container.__prismIO` original por una variable de closure (mismo
 * comportamiento, sin propiedades ad-hoc sobre el nodo DOM).
 */
