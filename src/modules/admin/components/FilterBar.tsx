...
import { useFilterOptions } from "@/modules/admin/hooks/useFilterOptions";
...
export function FilterBar({ filters, onChange, onReset }: FilterBarProps) {
  // Opciones reales de OpenProject vía `/api/admin/filter-options` (ver ADMIN_ANALYTICS_PLAN.md §14).
