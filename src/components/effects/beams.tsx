...
function MergedPlanes({ material, width, count, height, ref }: MergedPlanesProps) {
  ...
  useFrame((_, delta) => {
    ...
    // eslint-disable-next-line react-hooks/immutability -- three.js per-frame uniform mutation happens outside React's render cycle
