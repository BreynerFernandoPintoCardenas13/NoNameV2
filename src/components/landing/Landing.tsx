...
/**
 * Landing pública — sin backend todavía; los botones solo dejan la
 * navegación preparada. El cursor animado es exclusivo de esta vista: el
 * resto de la app (login, dashboard, notas...) usa el cursor nativo.
 */
